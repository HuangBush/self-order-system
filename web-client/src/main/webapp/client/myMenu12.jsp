  	...
  	<div style="margin-top: 15%">
  		...
  		<!-- 已开台桌台详单 -->
     		<div style="width: 70%;margin-left: 15%;">
     			...
     			<div><fmt:formatDate value="${os1.os_regtime }" pattern="yyyy-MM-dd hh:mm"/></div>
     			...
     			<div>
     				<table >
     					<tr height="20px" >
   							<th align="left" width="100px" style="text-align: center;font-size: 14px">合计</th>
   							<th align="right" width="100px"  style="font-size: 14px">${os.os_allprice }元</th>
     					</tr>
     				</table>
     			</div>
     			<br/>
     			<div>
     				<!-- 原菜单详细 -->
     				<div>------------------------原菜单详细-----------------------</div>
     				<c:forEach items="${os1.oiList }" var="oi">
	     				<table style="margin-bottom: 10px;">
	     					<tr  style="width: 100%;height:20px;text-align: center;">
	   							<td  width="100px">${oi.menu.m_name }</td>
	   							<td  width="60px;">${oi.oi_num }</td>
     			...
     			<div>
     				<table >
     					<tr height="20px" >
   							<th align="left" width="100px" style="text-align: center;font-size: 14px">合计</th>
   							<th align="right" width="100px" style="font-size: 14px">${os1.os_allprice }元</th>
     					</tr>
     				</table>
     			</div>
     			<br/>
     			...
     			<div>
     				<table >
     					<tr height="20px" >
   							...
   							<th align="right" width="80px" >${os1.os_allprice+os.os_allprice}元</th>
     					</tr>
     				</table>
     			</div>
     			<br/>
